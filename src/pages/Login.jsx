...
const Login = ({ onLogin }) => {
  ...
  // --- PERBAIKAN DI SINI ---
  // Baca localStorage LANGSUNG saat inisialisasi state.
  // Ini mencegah "shuttering" karena warna sudah siap sebelum render pertama.
  ...
  const handleLogin = (e, type) => {
    ...
    setTimeout(() => {
      ...
      if (type === 'google') {
        localStorage.setItem('userName', 'Yonaldi Ernanda Putro'); 
      } else {
        ...
        <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="space-y-6">
            ...
            <button 
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 font-bold py-3.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all shadow-sm active:scale-[0.98] group"
            >
              {isLoading ? (
            ...
            <form onSubmit={(e) => handleLogin(e, 'manual')} className="space-y-4">
