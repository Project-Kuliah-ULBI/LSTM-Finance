// forecast.js - Updated with 365-Day Windowing & Terminal Debugging
const express = require('express');
const router = express.Router();
const pool = require('../config/supa'); // Pastikan path config database benar
...
const PYTHON_API_TIMEOUT = 45000; // 45 detik untuk pemrosesan LSTM berat
...
router.get('/analyze', validateForecastRequest, async (req, res) => {
  ...
  try {
    ...
    console.log(`   - Rentang Data     : 365 Hari Terakhir`);
    console.log('===========================================\n');
